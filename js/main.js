...
acaBookApp = (function($, window, appConfig, undefined){
	...
	Mode.prototype.isShowable = function(){
		wellIsIt = (this.settings.forcePhone && this.app.isPhone)
				|| (
